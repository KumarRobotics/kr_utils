...
void win_change_attributes(std::ostream& stream, int foreground,
                           int background = -1);
#endif
}
...
inline std::ostream& grey(std::ostream& stream) {
  if (__internal::is_atty(stream)) {
    ...
    stream << "\033[30m";
#elif defined(OS_WINDOWS)
    __internal::win_change_attributes(stream, 0  // grey (black)
                                      );
#endif
  }
  return stream;
...
inline std::ostream& white(std::ostream& stream) {
  if (__internal::is_atty(stream)) {
    ...
    stream << "\033[37m";
#elif defined(OS_WINDOWS)
    __internal::win_change_attributes(
...
inline std::ostream& on_grey(std::ostream& stream) {
  if (__internal::is_atty(stream)) {
    ...
    stream << "\033[40m";
#elif defined(OS_WINDOWS)
    __internal::win_change_attributes(stream, -1, 0  // grey (black)
                                      );
#endif
  }
  return stream;
